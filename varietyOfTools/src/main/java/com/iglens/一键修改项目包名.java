 ...
 */
@Slf4j
public class 一键修改项目包名 {

    private static final String GROUP_ID = "com.xiaolanzhua";
    private static final String ARTIFACT_ID = "xiaolanzhua";
    private static final String PACKAGE_NAME = "com.xiaolanzhua";
    private static final String TITLE = "小蓝爪管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.xiaolanzhua";
        String artifactIdNew = "xiaolanzhua";
        String packageNameNew = "com.xiaolanzhua";
        String titleNew = "小蓝爪管理系统";
