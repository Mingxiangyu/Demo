...
public class IdWorker {
  ...
  // ==============================Fields===========================================
  /** 开始时间截 (2017-01-01) */
  private final long twepoch = 1483228800000L;
  ...
  private IdWorker() {
    ...
    System.out.println(
        String.format(
            "id worker starting. timestamp left shift %d, datacenter id bits %d, worker id bits %d, sequence bits %d, datacenterId %d, workerid %d",
            timestampLeftShift,
            datacenterIdBits,
            workerIdBits,
            sequenceBits,
