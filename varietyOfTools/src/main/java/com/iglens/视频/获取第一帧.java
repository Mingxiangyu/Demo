...
public class 获取第一帧 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String movPath = "/Users/ming/截图/iShot2022-01-25 15.41.52.mov";
    randomGrabberFFmpegImage(movPath, "/Users/ming/截图", "test2");
    // randomGrabberFFmpegImage("C:/Users\\Administrator\\Desktop\\VID_20171229_162251.mp4",
    // "G:\\test", "111");
  }

  public static void randomGrabberFFmpegImage(
      String filePath, String targerFilePath, String targetFileName) throws Exception {
    // 创建视频帧抓取工具
