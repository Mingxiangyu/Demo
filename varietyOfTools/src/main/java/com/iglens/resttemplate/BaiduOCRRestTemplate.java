...
public class BaiduOCRRestTemplate {
     ...
     * 默认基础格式配置
     */
    public static String base_style = "{\"title\":{\"cn_font\":{\"name\":\"黑体\",\"size\":\"16pt\"},\"en_font\":{\"name\":\"黑体\",\"size\":\"16pt\"}},\"content\":{\"cn_font\":{\"name\":\"仿宋_GB2312\",\"size\":\"16pt\"},\"en_font\":{\"name\":\"仿宋_GB2312\",\"size\":\"16pt\"}}}";
    ...
    public HttpEntity createTask(MultipartFile file) throws IOException {
        ...
        return this.createTask(new ObjectId().toString(), doc_type_general, is_scanned_false, parse.toJSONString(), file);
    }
    ...
    public HttpEntity createTask(File file) throws IOException {
        JSONObject parse = JSONObject.parseObject(base_style);
        return this.createTask(new ObjectId().toString(), doc_type_general, is_scanned_true, parse.toJSONString(), file);
    }
     ...
     * @return
     */
    public HttpEntity createTask(String taskName, String docType, String isScanned, String style, File file) {
     ...
     * @return
     */
    public HttpEntity createTask(String taskName, String docType, String isScanned, String style, MultipartFile file) throws IOException {
        MultiValueMap<String, Object> param = new LinkedMultiValueMap<>();
        param.add("name", taskName);
        param.add("doc_type", docType);
        param.add("is_scanned", isScanned);
     ...
     * @return
     */
    public HttpEntity pageTask(String id, String name, Integer pageSize, Integer pageNo, String orderby, String order) {
        MultiValueMap<String, Object> param = new LinkedMultiValueMap();
        param.add("Id", id);
//        param.add("name", name);
     ...
     * @return
     */
    public HttpEntity pageDocByTask(String task_id, String name, Integer pageSize, Integer pageNo, String orderby, String order) {
        MultiValueMap<String, Object> param = new LinkedMultiValueMap();
        param.add("name", name);
        param.add("page_size", pageSize);
        param.add("page_no", pageNo);
    ...
    public HttpEntity pageDoc(String id, String name, Integer pageSize, Integer pageNo, String orderby, String order) {
        MultiValueMap<String, Object> param = new LinkedMultiValueMap();
//        param.add("Id", id);
