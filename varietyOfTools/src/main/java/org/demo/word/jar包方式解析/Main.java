...
import static org.demo.word.jar包方式解析.MriReportService.findAllFile;
import static org.demo.word.jar包方式解析.MriReportService.findSub;
import static org.demo.word.jar包方式解析.MriReportService.findYearAndSource;
