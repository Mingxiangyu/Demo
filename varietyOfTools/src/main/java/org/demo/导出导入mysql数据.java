 ...
 * @author T480s
 */
public class 导出导入mysql数据 {


  public static void main(String[] args) throws IOException {
    InputStream is = 导出导入mysql数据.class.getClassLoader().getResourceAsStream("jdbc.properties");
    Properties properties = new Properties();
    properties.load(is);
    导出导入mysql数据.export(properties); // 这里简单点异常我就直接往上抛
    //    导出导入mysql数据.importSql(properties);
  }
