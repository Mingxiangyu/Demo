...
// TODO   PathMatchingResourcePatternResolver中传入的 locationPattern 中间的 斜线/ 不能使用 File.separator ,必须使用 / ，否则会匹配不到
    ...
    Resource[] resources2 = new PathMatchingResourcePatternResolver().getResources(
        ResourceUtils.CLASSPATH_URL_PREFIX + s);

    //  加载当前项目及所有jar中classpath下的所有META-INF/spring.factories文件（springboot自动装配的主要功能）
    Resource[] resources3 = new PathMatchingResourcePatternResolver().getResources(
